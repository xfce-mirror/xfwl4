...
impl std::fmt::Debug for X11Renderer<'_> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_tuple("X11Renderer").field(&self.0).finish()
    }
}

impl RendererSuper for X11Renderer<'_> {
...
impl ImportDma for X11Renderer<'_> {
...
impl ExportMem for X11Renderer<'_> {
...
impl Offscreen<GlesRenderbuffer> for X11Renderer<'_> {
...
impl Bind<GlesRenderbuffer> for X11Renderer<'_> {
...
impl ImportMem for X11Renderer<'_> {
    fn import_memory(
        &mut self,
        data: &[u8],
        format: Fourcc,
...
impl ImportMemWl for X11Renderer<'_> {
...
impl ImportDmaWl for X11Renderer<'_> {}

#[cfg(feature = "egl")]
impl ImportEgl for X11Renderer<'_> {
