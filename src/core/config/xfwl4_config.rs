...
fn settings() -> HashMap<String, RcSetting> {
    [
        ...
        RcSetting::new("shadow_delta_height", RcValueType::Int, true, true, true),
        RcSetting::new("shadow_delta_width", RcValueType::Int, true, true, true),
        RcSetting::new("shadow_delta_x", RcValueType::Int, true, true, true),
        RcSetting::new("shadow_delta_y", RcValueType::Int, true, true, true),
        RcSetting::new("shadow_opacity", RcValueType::Int, true, true, true),
        RcSetting::new("show_app_icon", RcValueType::Bool, true, true, true),
        RcSetting::new("show_dock_shadow", RcValueType::Bool, true, false, true),
        RcSetting::new("show_frame_shadow", RcValueType::Bool, true, true, true),
